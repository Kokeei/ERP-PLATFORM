...
- Tests E2E : Playwright (`tests/`, `npm test`) — voir `tests/README.md`. `tests/agent-rh/` couvre le portail self-service agent (navigation, demandes RH, tâches, notifications, tableau de bord). `tests/ged.spec.js` couvre le module GED et son intégration au dossier agent RH.
